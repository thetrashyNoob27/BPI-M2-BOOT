...
__attribute__((section("__versions"))) = {
	...
	{ 0xaeb3b687, __VMLINUX_SYMBOL_STR(__gameport_register_port) },
	{ 0x386ee72d, __VMLINUX_SYMBOL_STR(gameport_set_phys) },
	...
	{ 0x92069b9, __VMLINUX_SYMBOL_STR(gameport_unregister_port) },
