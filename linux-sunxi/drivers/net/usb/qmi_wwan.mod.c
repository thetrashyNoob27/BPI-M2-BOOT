...
__attribute__((section("__versions"))) = {
	...
	{ 0x17e9ebfb, __VMLINUX_SYMBOL_STR(eth_commit_mac_addr_change) },
	{ 0x3358cca7, __VMLINUX_SYMBOL_STR(eth_prepare_mac_addr_change) },
	...
	{ 0x96873ade, __VMLINUX_SYMBOL_STR(usb_cdc_wdm_register) },
