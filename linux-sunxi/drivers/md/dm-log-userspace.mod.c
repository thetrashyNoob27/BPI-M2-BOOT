...
__attribute__((section("__versions"))) = {
	...
	{ 0xa4da478d, __VMLINUX_SYMBOL_STR(cn_add_callback) },
	...
	{ 0x28a674dc, __VMLINUX_SYMBOL_STR(dm_dirty_log_type_unregister) },
	...
	{ 0x2e24eae1, __VMLINUX_SYMBOL_STR(dm_dirty_log_type_register) },
