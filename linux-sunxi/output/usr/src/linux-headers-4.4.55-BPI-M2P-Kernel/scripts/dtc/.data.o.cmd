cmd_scripts/dtc/data.o := gcc -Wp,-MD,scripts/dtc/.data.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89    -Iscripts/dtc -Iscripts/dtc/libfdt -Iscripts/dtc/script_parser -c -o scripts/dtc/data.o scripts/dtc/data.c
